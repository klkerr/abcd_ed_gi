...
print("Baseline: secondary caregiver = father")
table(abcd.b.secFather$crpbi_acceptance_caregiver2)
...
print("Year 1: secondary caregiver = father")
table(abcd.y1.secFather$crpbi_acceptance_caregiver2)
...
print("Baseline CRPBI scores for all fathers")
describe(abcd.b.fathers$b.crpbi_father)
abcd.y1.fathers=rbind(abcd.y1.primFather,abcd.y1.secFather)
print("Year 1 CRPBI scores for all fathers")
describe(abcd.y1.fathers$y1.crpbi_father)
...
describe(abcd.b.mothers$b.crpbi_mother)
abcd.y1.mothers=rbind(abcd.y1.primMother,abcd.y1.secMother)
describe(abcd.y1.mothers$y1.crpbi_mother)
